...
function HeroSection() {
  ...
  const handleSearch = (e) => {
    ...
    // Only dispatch if there's an actual query
    if (trimmedQuery) {
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1
              className="text-4xl md:text-6xl font-extrabold text-center lg:text-left
            ...
            <p className="text-lg text-gray-600 text-center lg:text-left max-w-xl mx-auto lg:mx-0">
              ...
              goals. Your next professional milestone is just a search away.
            </p>

            <div className="max-w-xl mx-auto lg:mx-0">
              <div
                className="relative flex shadow-lg rounded-full
          ...
          <div className="hidden lg:block relative">
            <div
              className="absolute -top-12 -right-12 w-96 h-96
              bg-blue-100 rounded-full blur-3xl opacity-50"
            ></div>
